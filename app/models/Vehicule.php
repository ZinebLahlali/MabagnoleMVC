<?php
   ...
   class Vehicule extends BaseModel {
      ...
      // public function __construct($id_car = null,$modele = null, $prix = null, $disponible = null, $carburant = null,$boit_vitesse = null, $nb_places = null, $marque = null, $bagages = null,$image = null, $id_cate = null)
      // {
      //    parent::__construct(); //db initialisée
      //    $this->id_car = $id_car;
      //    $this->modele = $modele;
      //    $this->prix = $prix;
      ...
      public static function find(int $id_car)
      {   $sql = "SELECT *
            FROM vehicules WHERE id_car = ?";
